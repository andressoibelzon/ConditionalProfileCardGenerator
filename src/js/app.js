...
function render(variables = {}) {
  ...
  if (variables.lastname === null) variables.lastname = "Holmes";
  if (variables.role === null) variables.role = "Space Cleaner";
  if (variables.city === null) variables.city = "Somewhere";
